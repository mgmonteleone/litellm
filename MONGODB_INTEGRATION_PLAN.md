...
| Sidecar PR 2 (filters, score threshold, exact, hybrid, discovery) | Not started |
| LiteLLM PR 4 (`/vector_store/test_connection`, discovery proxy) and PR 5 (dashboard) | Not started |
| Commits / forks / upstream PRs | Nothing committed yet; branches only |
